...
use App\Http\Controllers\Admin\LandAreaTypeController;
...
Route::group(['prefix' => '/', 'namespace' => 'Front'], function () {
	...
	Route::get('/property', 'FrontEndController@property')->name('allproperty');
	Route::get('/property/{slug}', 'FrontEndController@propertyDetails')->name('propertyDetails');
	Route::get('/property-buy', 'FrontEndController@propertyBuy')->name('propertybuy');
	Route::get('/property-rent', 'FrontEndController@propertyRent')->name('propertyrent');
