...
class ProductController extends Controller
{
    ...
    protected $area = null;
    protected $city = null;
    protected $landareatypes = null;
    protected $municipality = null;
    protected $propertyface = null;
    protected $ward = null;
    protected $year = null;
    ...
    public function __construct(
        Product $product,
        Category $_category,
        ProductImage $product_imagem,
        Segment $_segment,
        Area $_area,
        City $_city,
        LandAreaType $_landareatype,
        Municipality $_municipality,
        PropertyFace $_propertyface,
        Ward $_ward,
        Year $_year,
    ) {
        $this->product = $product;
        $this->category = $_category;
        $this->product_image = $product_imagem;
        $this->segment = $_segment;
        $this->area = $_area;
        $this->city = $_city;
        $this->landareatypes = $_landareatype;
        $this->municipality = $_municipality;
        $this->propertyface = $_propertyface;
        $this->ward = $_ward;
        $this->year = $_year;
    }
    /**
    ...
    public function create()
    {
        ...
        $wards = Ward::all();
        $property_faces = PropertyFace::all();
        $property_years = Year::all();
        $landareatypes = LandAreaType::all();
        $segments = Segment::all();

        return view('admin.product.create', compact('product_info', 'category_info', 'grand_child_cat', 'child_cat', 'cities', 'areas', 'municipalities', 'wards', 'property_faces', 'property_years', 'landareatypes', 'segments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['landareatype_id'] = $request->landareatype_id;
        $data['propertyface_id'] = $request->propertyface_id;
        ...
        $data['restroom'] = $request->restroom;
        $data['attachedrestroom'] = $request->attachedrestroom;
        ...
        // if ($success && $request->hasFile('images')) {
    ...
    public function edit($id, Request $request)
    {
        ...
        // dd($grand_cat_info);
        $seg_info = $this->segment->where(['id' => $product_info->segment_id])->get();
        $city_info = $this->city->where(['id' => $product_info->city_id])->get();
        $area_info = $this->area->where(['id' => $product_info->area_id])->get();
        $municipality_info = $this->municipality->where(['id' => $product_info->municipality_id])->get();
        $ward_info = $this->ward->where(['id' => $product_info->ward_id])->get();
        $property_year_info = $this->year->where(['id' => $product_info->year_id])->get();
        $property_face_info = $this->propertyface->where(['id' => $product_info->propertyface_id])->get();
        $landareatype_info = $this->landareatypes->where(['id' => $product_info->landareatype_id])->get();

        //dd($city_info);
        //or this
        //    $seg_info = $product_info->segment_id;
        //    $seg_info = Segment::all();
        // dd($seg_info);
