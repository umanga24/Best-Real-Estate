...
class CategoryController extends Controller
{
    ...
    public function __construct(Category $category, Segment $segment)
    {
    ...
    public function create()
    {
       ...
       // dd($segments);
        ...
        return view('admin.category.create', compact('category_info', 'parents_cat', 'segments'));
    }
    ...
    public function edit($id)
    {
        ...
        $parents_cat = $this->category->where('show_in_menu', 1)->orderBy('title', 'ASC')->get();
        $seg_info = $this->segment->where(['id' => $category_info->segment_id])->get();

        $segments = $this->segment->all();

        return view('admin.category.create', compact('category_info', 'parents_cat','segments','seg_info'));
    }
