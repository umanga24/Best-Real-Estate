...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Cities</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('city.create')}}">New City</a>
            </div>
        </div>
                    ...
                    <tr class='clickable-row' data-href="">
                        ...
                        <td>
                            <ul class="action_list">
                                <li>
                                    <a href="{{route('city.edit', $city->id)}}" data- class="btn btn-info btn-md"><i class="fa fa-edit"></i></a>
