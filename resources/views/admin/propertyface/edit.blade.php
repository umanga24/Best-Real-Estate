        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('propertyface.update', $propertyface->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')

                        <div class="form-group">
                            <label for="process_title">Process_title</label>
                            <input id="title" class="form-control" type="text" name="direction" value="{{$propertyface->direction}}" placeholder="enter property face">
                        </div>
