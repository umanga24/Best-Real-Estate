        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1>Municipality</h1>
                    <a href="{{route('municipality.index')}}" class="float-end btn btn-info">Back</a>

                </div>

                <div class="card-body">

                    <form action="{{route('municipality.update', $municipality->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')

                        <div class="form-group">
                            <label for="process_title">Process_title</label>
                            <input id="title" class="form-control" type="text" name="name" value="{{$municipality->name}}" placeholder="enter munacipality">
                        </div>
